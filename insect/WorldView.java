...
public class WorldView extends GridWorldView {
    ...
    public void draw(Graphics g, int x, int y, int object) {
        switch (object) {
			case WorldModel.INFECTED:   g.setColor(Color.yellow);  break;
			case WorldModel.HEALTHY:    g.setColor(Color.white);  break;
			case WorldModel.OBSTACLE: 	g.setColor(Color.black); break;
        }
    ...
    public void drawPlant(Graphics g, int x, int y) {
		g.fillRect(x * cellSizeW, y * cellSizeH, cellSizeW, cellSizeH);
